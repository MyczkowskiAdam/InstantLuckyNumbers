...
extern "C"
JNIEXPORT jstring JNICALL Java_com_luckynumbers_mycax_instantluckynumbers_getyournumber_MainActivity_Calculate (JNIEnv *env, jobject, jstring cFirstName, jstring cLastName) {
